 ...
 *
 * @example Final Fantasy, Mega Man 2, Blaster Master, Metroid, Kid Icarus, Zelda, Zelda 2, Castlevania 2
 * @description http://wiki.nesdev.com/w/index.php/INES_Mapper_001
 * @constructor
 */
...
/**
 * Mapper 002 (UxROM (and compatible))
 *
 * @example Mega Man, Castlevania, Contra, Duck Tales, Metal Gear
 * @description http://wiki.nesdev.com/w/index.php/INES_Mapper_002
 * @constructor
 */
...
/**
 * Mapper 004 (MMC3, TxROM, (MMC6, HxROM))
 *
 * @example Mega Man 3, 4, 5, 6, Kirby's Adventure, Gauntlet, Rad Racer 2, Startropics 1, 2 (MMC6), Super Mario Bros. 2, 3, ... a zillion other games (most common mapper)
 * @description http://wiki.nesdev.com/w/index.php/INES_Mapper_004
 * @constructor
 */
